...
for o in bpy.context.view_layer.objects:
 ...
 if len(o.data.polygons)>2:continue
 ...
 if max(hi[k]-lo[k] for k in range(3))<5:continue
...
(D/'ktx-planar-object-audit.json').write_text(json.dumps(rows,ensure_ascii=False,indent=2));print(rows)
