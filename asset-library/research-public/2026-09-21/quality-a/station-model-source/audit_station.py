...
result=bpy.ops.import_scene.skp(filepath=str(D/'station-extracted/부산역(수정).skp'))
...
(D/'station-geometry-audit.json').write_text(json.dumps(receipt,ensure_ascii=False,indent=2));bpy.ops.wm.save_as_mainfile(filepath=str(D/'station-imported.blend'))
