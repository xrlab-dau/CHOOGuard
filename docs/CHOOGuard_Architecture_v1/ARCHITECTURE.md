# CHOOGuard 전체 아키텍처 설계서
## Unity Native · Evidence-driven Operations Simulator

**버전 1.0.0 · 2026-09-19 · PRD v11 / Unity Native UX v2 기반**

이 문서는 구현할 책임·인터페이스·저장·계산·검증 경계를 결정한다. 현재 구현과 새 설계를 구분하며, 테스트/승인 상태를 자동 승격하지 않는다.

### 빠른 읽기

제품: §00–02, §14–16. Unity: §03–05, §07–09. 물리: §04, §08–09, §14. AI/문서: §06, §10–12. 저장/배포: §07, §10, §13. 전체 그림은 `diagrams/INDEX.md`, 형식 계약은 `INTERFACES.md`, 구현 책임은 `TRACEABILITY.md`를 읽는다.
...
직접 URL·확인 범위는 [SOURCES.md](SOURCES.md)에 있다. [SRC-*]는 해당 파일의 식별자다.
