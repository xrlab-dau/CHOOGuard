> **역사 범위 안내 · 2026-09-12**
> 아래 로컬/학교 작업 배치는 당시 인계 이력이다. 현재 장소·고사양 제한과 CV 재개 지시로 쓰지 않는다. 검증 사실은 당시 SHA·범위 그대로 보존한다.
> [현재 PM 실행 계약](pm-execution-contract.md)을 먼저 읽는다. 아래 원문과 과거 검증 범위는 삭제하거나 새 PASS로 바꾸지 않았다.
