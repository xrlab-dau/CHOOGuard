...
Unity CLI 1.0.0-beta.8, Unity 6000.3.23f1/Windows 모듈과 Pipeline 0.6.0-exp.1 설치·고정을 확인했다. 공식 Editor MCP의 초기화·149개 도구 조회·실제 Editor/씬/Console 읽기, EditMode 52/52와 PlayMode 6/6, 모드 전환 후 연결 및 Console 오류 0을 검증했다. Codex·Claude Code 등록과 Claude Code `Connected`를 확인했으며 기존 대화는 도구 목록 재연결이 필요하다. [ADR 0006](../adr/0006-official-unity-editor-mcp.md)과 [실패·복구를 포함한 검증 기록](../evidence/foundation/2026-09-08-official-editor-mcp.json)을 따른다. 전체 Windows 빌드·HMD 수용 및 M1-04의 실행 경계 검토는 별도다.
